        ...
        <Box>
            ...
            <Box bg="brand.50" width="100vw" height="50vh">
                <Flex className="textContainer-1" justifyContent="center" width="100%" padding="1%">
                    <Heading color = "signal.selected" text-align = "center" font-family="Mitr" font-size="48px" font-style="normal" font-weight="400" line-height="normal" padding=".5%" >Effortlessly</Heading>
                    <Heading color = "#FFFFFF" text-align = "center" font-family="Mitr" font-size="48px" font-style="normal" font-weight="400" line-height="normal" padding=".5%">Navigate and Park</Heading>
                </Flex>
                <Flex className="textContainer-2" justifyContent="center" width="100%">
                    <Heading color = "#FFFFFF" text-align = "center" font-family="Mitr" font-size="48px" font-style="normal" font-weight="400" line-height="normal" paddingRight=".5%">with</Heading>
                    <Heading color = "signal.selected" text-align = "center" font-family="Mitr" font-size="48px" font-style="normal" font-weight="400" line-height="normal" paddingLeft=".5%">Precision</Heading>
                </Flex>
                <Flex justifyContent="center" alignItems="center" w="100%" padding="1%">
                    <Flex className="textContainer-3" justifyContent="center" width="60%" justifySelf="center">
                        <Text color="#FFF" textAlign="center" fontFamily="Mitr"  fontStyle="normal" fontWeight="400" lineHeight="normal">
